...
IA_OP(hip_bfloat16, int64_t, ia_i64_bf16)
IA_OP(hip_bfloat16, uint32_t, ia_u32_bf16)
IA_OP(hip_bfloat16, uint8_t, ia_u8_bf16)
SA_OP(hip_bfloat16, int64_t, sa_i64_bf16)
SA_OP(hip_bfloat16, uint32_t, sa_u32_bf16)
SA_OP(hip_bfloat16, uint8_t, sa_u8_bf16)
S_OP(hip_bfloat16, int64_t, s_i64_bf16)
S_OP(hip_bfloat16, uint32_t, s_u32_bf16)
S_OP(hip_bfloat16, uint8_t, s_u8_bf16)
