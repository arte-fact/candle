...
UNARY_OP(hip_bfloat16, usin_bf16, sing(x))
UNARY_OP(hip_bfloat16, ucos_bf16, cosg(x))
UNARY_OP(hip_bfloat16, utanh_bf16, tanhg(x))
UNARY_OP(hip_bfloat16, uerf_bf16, erfg(x))
UNARY_OP(hip_bfloat16, uceil_bf16, ceilg(x))
UNARY_OP(hip_bfloat16, ufloor_bf16, floorg(x))
UNARY_OP(hip_bfloat16, uround_bf16, roundg(x))
UNARY_OP(hip_bfloat16, unormcdf_bf16, normcdfg(x))
UNARY_OP(hip_bfloat16, uabs_bf16, absg(x))
UNARY_OP(hip_bfloat16, usqr_bf16, x*x)
UNARY_OP(hip_bfloat16, usqrt_bf16, sqrtg(x))
UNARY_OP(hip_bfloat16, ugelu_bf16, gelu_fwd(x))
UNARY_OP(hip_bfloat16, ugelu_erf_bf16, gelu_erf_fwd(x))
UNARY_OP(hip_bfloat16, urelu_bf16, relu_fwd(x))
UNARY_OP1(hip_bfloat16, uelu_bf16, elu_fwd(x, param))
UNARY_OP(hip_bfloat16, usilu_bf16, silu_fwd(x))
UNARY_OP1(hip_bfloat16, upowf_bf16, powg(x, param))
UNARY_OP(hip_bfloat16, usign_bf16, sign_(x))
UNARY_OP(hip_bfloat16, usigmoid_bf16, sigmoid_fwd(x))

// fp8 -- not supported on AMD gfx906
