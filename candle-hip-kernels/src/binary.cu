...
BINARY_OP(hip_bfloat16, badd_bf16, x + y)
BINARY_OP(hip_bfloat16, bdiv_bf16, x / y)
BINARY_OP(hip_bfloat16, bmul_bf16, x * y)
BINARY_OP(hip_bfloat16, bsub_bf16, x - y)
BINARY_OP(hip_bfloat16, bmaximum_bf16, maxg(x, y))
BINARY_OP(hip_bfloat16, bminimum_bf16, ming(x, y))
BINARY_OP_OUT(hip_bfloat16, uint8_t, eq_bf16, x == y)
BINARY_OP_OUT(hip_bfloat16, uint8_t, ne_bf16, x != y)
BINARY_OP_OUT(hip_bfloat16, uint8_t, lt_bf16, x < y)
BINARY_OP_OUT(hip_bfloat16, uint8_t, le_bf16, x <= y)
BINARY_OP_OUT(hip_bfloat16, uint8_t, gt_bf16, x > y)
BINARY_OP_OUT(hip_bfloat16, uint8_t, ge_bf16, x >= y)
