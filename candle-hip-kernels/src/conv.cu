...
__device__ void upsample_bilinear2d(
    ...
    // Convert to double for computation to avoid type issues with __half and hip_bfloat16
...
CONV1D_OP(hip_bfloat16, float, conv1d_bf16)
CONV2D_OP(hip_bfloat16, float, conv2d_bf16)
CONVT1D_OP(hip_bfloat16, float, conv_transpose1d_bf16)
CONVT2D_OP(hip_bfloat16, float, conv_transpose2d_bf16)
AVG_POOL2D_OP(hip_bfloat16, float, avg_pool2d_bf16)
MAX_POOL2D_OP(hip_bfloat16, max_pool2d_bf16)
UPSAMPLE_NEAREST2D_OP(hip_bfloat16, upsample_nearest2d_bf16)
UPSAMPLE_BILINEAR2D_OP(hip_bfloat16, upsample_bilinear2d_bf16)
IM2COL_OP(hip_bfloat16, im2col_bf16)
IM2COL1D_OP(hip_bfloat16, im2col1d_bf16)
COL2IM1D_OP(hip_bfloat16, col2im1d_bf16)

// NOTE: No conv ops for fp8 (not supported on AMD gfx906)
